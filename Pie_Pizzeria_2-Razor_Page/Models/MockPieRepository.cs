        ...
        private void InitializePies()
        {
            _pies = new List<Pie>
            {
                new Pie {
                        ...
                        LongDescription = "Extra thin crust with a Basil Pesto Sauce, Oven Roasted Chicken Breast, " +
                        "Fresh Shiitake and Champignon Mushrooms, Sicilian Spiced Tomatoes, Whole Roasted Garlic Cloves, " +
                        "Mozzarella Cheese and finished with a light drizzle of Truffle Oil..",
                ...
                new Pie {
                        ...
                        LongDescription = "The Pie's hand tossed dough layered with a creamy mixture of whipped Cream Cheese, " +
                        "Fresh Spinach leaves, Artichoke Hearts, Chicken Breast, Mozzarella Cheese and a touch of tangy Marinara - " +
                        "Baked and topped with diced Tomatoes, fresh-cut Basil and a drizzle of sweet Balsamic reduction.",
                ...
                new Pie {
                        ...
                        LongDescription = "Our special Garlic Ranch Sauce topped with seasoned oven roasted Chicken " +
                        "Breast, Crisp Bacon, Tomatoes, Onions, Sharp Cheddar, and Mozzarella Cheese.",
                ...
                new Pie {
                        ...
                        LongDescription = "Looking for something different to eat? A perfect blend of spicy Thai peanut sauce, " +
                        "chicken breast, carrots, red onions, pineapple, fresh basil and chopped cilantro on a thin crust topped " +
                        "with light mozzarella and toasted sesame seeds. You won't regret it...",
